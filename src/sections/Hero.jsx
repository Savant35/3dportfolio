...
const Hero = () => {
  return (
    <section className="min-h-screen w-full flex items-center relative c-space" id="home">
      <div className="grid lg:grid-cols-2 gap-y-20 gap-x-16 items-center w-full max-w-7xl mx-auto">

        {/* Left Column: Text Content */}
        <div className="flex flex-col text-center lg:text-left">
          <p className="hero_tag text-gray_gradient">
            Hi, I'm Ali Arthur <span className="waving-hand font-sans text-gray-200">👋</span>
          </p>
